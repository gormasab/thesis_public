...
from functions.basics import scale_im

""""
Improved version of Projasis.py
function that makes and shows depth pictures. close window to refresh each picture. 
"""
...
while True:
    ...
    depth_show = scale_im(depth_image,4000)
